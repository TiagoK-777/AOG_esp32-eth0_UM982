...
- `Serial1` (GPIO4/RX, GPIO2/TX) @ 9600 → Rádio RTK
- `Serial` (USB) @ 115200 → Debug/AgIO (opcional)

**I2C (Wire):**
- SDA=GPIO32, SCL=GPIO33 → BNO08x IMU + ADS1115 ADC
- Inicializado em `autosteerSetup()`: `Wire.begin(32, 33)`

**PWM Motor (LEDC):**
- GPIO14 → DIR1_RL_ENABLE
- GPIO4 → PWM1_LPWM (LEDC canal 0)
- GPIO2 → PWM2_RPWM (LEDC canal 1)
