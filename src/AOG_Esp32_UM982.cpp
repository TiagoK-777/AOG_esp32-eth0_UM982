...
bool baseLineCheck = false;   //Set to true to use IMU fusion with UM982. Habilitar se estiver usando antenas duplas com UM982.
...
#define REPORT_INTERVAL 10     //BNO report time (ms). BNO085 RVC @ 100Hz (10ms) - optimal match
